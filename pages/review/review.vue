		...
		<view class="content">
			...
			<view class="review-form">
				<view class="review-rate-form mb-20">
					...
					<rate-form-item v-model="form.score_product" label="产品" tips="，如您所期待吗？"></rate-form-item>
					<rate-form-item v-model="form.score_enviroment" label="环境" tips="您满意吗？"></rate-form-item>
				</view>
